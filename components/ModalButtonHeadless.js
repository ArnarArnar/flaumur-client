                ...
                initialFocus={modalRef}
                    ...
                    <div className="min-h-screen px-4 text-center">
                        ...
                        <Transition.Child
                            ...
                            <div className="inline-block w-full max-w-md  text-left align-top mt-52 transition-all transform bg-gray-500 shadow-xl rounded-2xl">
                                ...
                                <div className="relative flex flex-col w-full bg-gray-700 border-0 rounded-lg shadow-lg outline-none focus:outline-none">
                                       <Dialog.Description> <button
                                        className="p-3 border-b border-gray-500 w-full last:border-b-0"
                                        onClick={() => {
